...
import { languageOptions } from "@/constants/navigation";
      ...
      <DropdownMenuTrigger asChild>
        <Button
          ...
          className={cn(
            ...
            sizeClasses[size],
            isMobile 
              ? "hover:bg-gradient-to-r hover:from-purple-500/20 hover:to-pink-500/20 px-2 py-1 rounded-lg transition-all duration-300 hover:scale-105"
              : "px-2 lg:px-3",
            className
          )}
        >
